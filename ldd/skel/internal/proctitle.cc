...
bool ProcTitle::Init(int argc, char** argv) { return true; }
void ProcTitle::Set(const std::string& title) {
...
bool ProcTitle::Init(int argc, char** argv) {
    assert(g_argv == NULL);
    g_argc = argc;
    g_argv = argv;
